...
if(NOT "/home/audren/lidarCameraCalib/calib_ws/src/find_camera_pose/include " STREQUAL " ")
  set(find_camera_pose_INCLUDE_DIRS "")
  set(_include_dirs "/home/audren/lidarCameraCalib/calib_ws/src/find_camera_pose/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'find_camera_pose' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/audren/lidarCameraCalib/calib_ws/src/find_camera_pose/${idir}'.  Ask the maintainer 'audren <audren@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/audren/lidarCameraCalib/calib_ws/devel/lib;/home/audren/lidarCameraCalib/calib_ws/devel/lib;/home/audren/basler_ws/devel/lib;/home/audren/bluefox_ws/devel/lib;/home/audren/ps4eye_ws/devel/lib;/opt/ros/indigo/lib)
